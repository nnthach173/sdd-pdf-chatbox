  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-[#1c2027] px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30"
      ...
      <button
        ...
        className="w-full rounded-lg border border-border bg-[#1c2027] px-4 py-2.5 text-sm font-medium text-foreground hover:bg-[#252a33] transition-colors flex items-center justify-center gap-2"
      >
