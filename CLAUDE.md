...
- 002-pdf-split-view: Added Python 3.11 (backend) · TypeScript / Next.js 14 App Router (frontend) + FastAPI, supabase-py (backend) · Tailwind CSS, shadcn/ui (frontend)
- 002-pdf-split-view: Added [e.g., Python 3.11, Swift 5.9, Rust 1.75 or NEEDS CLARIFICATION] + [e.g., FastAPI, UIKit, LLVM or NEEDS CLARIFICATION]
